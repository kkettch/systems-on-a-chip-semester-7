...
`define AUTOTB_TVIN_A  "./c.calc.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.calc.autotvin_B.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.calc.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.calc.autotvin_B.dat"
`define AUTOTB_TVOUT_result  "./c.calc.autotvout_result.dat"
`define AUTOTB_TVOUT_result_out_wrapc  "./impl_rtl.calc.autotvout_result.dat"
module `AUTOTB_TOP;
