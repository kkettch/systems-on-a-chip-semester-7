...
set solution_dir "C:/Users/s369027/Desktop/lab3/lab3-vivado-HLS/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {calc_tmp
calc_AXILiteS_s_axi
calc
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        addr_bits "10"
        port_width "AWADDR 10 WDATA 32 WSTRB 4 ARADDR 10 RDATA 32"
        ...
        memories "A {base_address 256 range 256} B {base_address 512 range 256} result {base_address 768 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 202 II x}
