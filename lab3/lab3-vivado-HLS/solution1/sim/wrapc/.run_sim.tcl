...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "calc.autotvin.dat"
	set constFileTvOut       "calc.autotvout.dat"
	set constFileHdlTvIn     "calc.autohdltvin.dat"
	set constFileHdlTvOut    "calc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
