...
#(parameter
    ...
    input  wire [5:0]                    result_address0,
...
assign RVALID  = (rstate == RDDATA) & !int_A_read & !int_B_read & !int_result_read;
...
assign int_result_address1 = ar_hs? raddr[7:2] : waddr[7:2];
