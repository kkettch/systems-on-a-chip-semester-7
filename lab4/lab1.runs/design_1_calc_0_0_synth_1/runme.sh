...
HD_PWD='H:/lab4/lab4-vivado/lab1.runs/design_1_calc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_calc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_calc_0_0.tcl
